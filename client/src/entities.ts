...
export type ApplicationCz <OverRelation extends string | never = never> = {
	...
	unique:
		...
		| Omit<{ hasPair: Paired['unique']}, OverRelation>
	columns: {
		id: string
		createdAt: string
		points: number | null
...
export type Country <OverRelation extends string | never = never> = {
	...
	hasManyBy: {
		...
		usersByDeleteMadeByPerson: { entity: Person; by: {deleteMadeByPerson: EventRegistration['unique']}  }
		...
		preferredApplicationsCzByHasPair: { entity: ApplicationCz; by: {hasPair: Paired['unique']}  }
	}
}
...
export type Image <OverRelation extends string | never = never> = {
	...
	hasManyBy: {
		...
		userProfilePictureByDeleteMadeByPerson: { entity: Person; by: {deleteMadeByPerson: EventRegistration['unique']}  }
...
export type Paired <OverRelation extends string | never = never> = {
	name: 'Paired'
	unique:
		| Omit<{ id: string}, OverRelation>
		| Omit<{ applicationCz: ApplicationCz['unique']}, OverRelation>
...
export type Person <OverRelation extends string | never = never> = {
	...
	unique:
		...
		| Omit<{ deleteMadeByPerson: EventRegistration['unique']}, OverRelation>
		| Omit<{ registrations: EventRegistration['unique']}, OverRelation>
		| Omit<{ notes: Note['unique']}, OverRelation>
	...
	hasMany: {
		...
		deleteMadeByPerson: EventRegistration<'deletedByPerson'>
	...
	hasManyBy: {
		...
		applicationsByHasPair: { entity: ApplicationCz; by: {hasPair: Paired['unique']}  }
		...
		deleteMadeByPersonByPaymentId: { entity: EventRegistration; by: {paymentId: string}  }
		registrationsByPaymentId: { entity: EventRegistration; by: {paymentId: string}  }
	}
}
