...
//Alternative layout
// const LayoutBodyUI = uic('div', { baseClass: 'bg-white h-full min-h-screen relative py-4 pl-[calc(100vw-100%)]' })
// const LayoutMaxWidthUI = uic('div', {
// 	baseClass: 'mx-auto transition-all',
// 	variants: {
// 		layout: {
...
// 	},
// })
// const LayoutBoxUI = uic('div', { baseClass: 'bg-white gap-1 flex flex-col lg:flex-row relative min-h-[calc(100vh-10rem)]' })

// const LayoutCenterPanelUI = uic('div', { baseClass: 'flex flex-col flex-2 p-4 gap-2 w-full flex-auto overflow-hidden' })
// const LayoutCenterTopUI = uic('div', { baseClass: 'flex justify-between pb-4 mb-4 border-b' })

// const LayoutLeftSidebarUI = uic('div', {
// 	baseClass: 'flex-col lg:border-r bg-white border-r-gray-300 lg:w-96 flex-auto gap-2 relative rounded-l-xl',
// 	variants: {
// 		visibility: {
// 			show: 'flex',
// 			hidden: 'hidden',
