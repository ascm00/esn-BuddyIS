...
export const Sidebar = forwardRef<HTMLDivElement, SidebarProps>(
	({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
			...
			return (
				<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
					<SheetContent
						...
						style={{ '--sidebar-width': SIDEBAR_WIDTH_MOBILE, backgroundColor: "#ffffff" } as CSSProperties}
						side={side}
					>
		...
		return (
			<div
				ref={ref}
				className="group peer hidden md:block text-sidebar-foreground bg-sidebar bg-gray-50"
				data-state={state}
