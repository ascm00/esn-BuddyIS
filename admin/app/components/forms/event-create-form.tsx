...
export const EventCreateForm = Component(() => {
	...
	return (<FormLayout>
		...
		<SelectField field={'contactPerson'} label="Contact person" options={'Person[tenantPerson.roles = "admin" || tenantPerson.roles = "esnMember" || tenantPerson.roles = "coordinator"]'}>
