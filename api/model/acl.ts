...
export const internationalStudentRole = c.createRole('internationalStudent', { stages: '*', s3: { '**': { upload: true, read: true } }, tenant: { invite: { czechBuddyRole: true, internationalStudentRole: true }}})
...
export const czechBuddyRole = c.createRole('czechBuddy', { stages: '*', s3: { '**': { upload: true, read: true } }, tenant: { invite: { czechBuddyRole: true, internationalStudentRole: true },} })
